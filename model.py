...
class User(dbase.Model, UserMixin):
    ...
    active = dbase.Column(dbase.Boolean)
    ...
    current_login_at = dbase.Column(dbase.DateTime, default=dt.now())
    current_login_ip = dbase.Column(dbase.String, default="0.0.0.0")
